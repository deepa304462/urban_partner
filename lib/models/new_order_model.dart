/// success : true
/// count : 1
/// data : [{"address":{"street1":"galino3","street2":"sector 59","city":"noida","state":"delhi","country":"india","timeSlot":"0","daySlot":"0"},"_id":"6501c1089f2cf406576360c4","userId":"64afef39721b42c441bfd18e","quantity":10,"cGst":100,"sGst":50,"total":3000,"paidAmount":0,"timeSlot":"0","daySlot":"0","categoryId":"649561bffafe7bde2fe8562c","subCategoryId":"64956a5aa1022b7390973c91","subsubCategoryId":"64a3b740b0482e6fa75dc3f1","serviceId":{"_id":"64a3c2abe8105c2df22b788e","name":"ac gas charging","categoryId":"649561bffafe7bde2fe8562c","subCategoryId":"64956a5aa1022b7390973c91","subsubCategoryId":"64a3b740b0482e6fa75dc3f1","vendorId":"649ec47dd7ecd578b7dfc8f5","status":"Active","price":300,"count":0,"__v":0},"servicePrice":300,"quantityService":1,"totalService":0,"paidAmountService":0,"courierWithBag":false,"notificationRecipent":false,"parcelValue":0,"orderStatus":"confirmed","returnStatus":"","paymentStatus":"paid","orderType":"Other","preparingStatus":"New","deliveryStatus":"","acceptOrRejected":"pending","startTime":"","endTime":"","otp":null,"accountVerification":false,"createdAt":"2023-09-13T14:02:48.876Z","updatedAt":"2023-09-13T14:03:11.251Z","__v":0}]
...
class NewOrderModel {
  ...
  num? _count;
  List<Order>? _data;
NewOrderModel copyWith({  bool? success,
  num? count,
  List<Order>? data,
}) => NewOrderModel(  success: success ?? _success,
  count: count ?? _count,
  data: data ?? _data,
);
...
/// address : {"street1":"galino3","street2":"sector 59","city":"noida","state":"delhi","country":"india","timeSlot":"0","daySlot":"0"}
/// _id : "6501c1089f2cf406576360c4"
...
/// createdAt : "2023-09-13T14:02:48.876Z"
/// updatedAt : "2023-09-13T14:03:11.251Z"
/// __v : 0
...
class Order {
  ...
  String? _updatedAt;
  num? _v;
Order copyWith({  Address? address,
  String? id,
  String? userId,
  num? quantity,
  num? cGst,
  ...
  String? updatedAt,
  num? v,
}) => Order(  address: address ?? _address,
  id: id ?? _id,
...
class Address {
  ...
  String? _timeSlot;
  String? _daySlot;
Address copyWith({  String? street1,
  String? street2,
  String? city,
  String? state,
  String? country,
  String? timeSlot,
  String? daySlot,
}) => Address(  street1: street1 ?? _street1,
